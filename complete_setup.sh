...
# Barn Lady - Complete Setup Script with Dependencies
# This script installs dependencies and restores full functionality

echo "🐴 Barn Lady - Complete Setup with Dependencies"
echo "==============================================="
...
python3 -m pip install streamlit requests --user

# Verify installations
echo "🔍 Verifying installations..."
python3 -c "import fastapi, pydantic, uvicorn" 2>/dev/null && echo "   ✅ 
FastAPI dependencies installed successfully" || echo "   ❌ FastAPI 
installation failed"
python3 -c "import streamlit, requests" 2>/dev/null && echo "   ✅ 
Streamlit dependencies installed successfully" || echo "   ❌ Streamlit 
installation failed"
...
echo ""
echo "🔍 If you still get dependency errors, try:"
echo "   pip3 install --upgrade fastapi uvicorn pydantic streamlit 
requests"
echo ""
